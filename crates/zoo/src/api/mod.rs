...
pub fn create_router(
    ...
    let protected_routes = Router::new()
        ...
        .route("/api/devices/:device_id/heartbeat", post(devices::heartbeat))
        ...
        .route("/api/uploads/:upload_id/heartbeat", post(uploads::heartbeat))
        .route("/api/uploads/:upload_id/complete", post(uploads::complete))
        .route("/api/uploads/:upload_id/register", post(uploads::register_file))
        .route("/api/uploads/:upload_id/fail", post(uploads::fail))
        .route("/api/uploads/:upload_id/parts/:part_number", put(uploads::confirm_part))
